        ...
        try:
            ...
            for env in environments:
                ...
                for container in containers:
                    ...
                    # Only process ports if we have container details
                    if details:
                        # Get PortBindings from container inspection details (more reliable than basic Ports array)
                        port_bindings = details.get('HostConfig', {}).get('PortBindings', {}) or {}
                        exposed_ports = details.get('Config', {}).get('ExposedPorts', {}) or {}
                        ...
                        # If no container details available, fall back to basic Ports array
